...
public interface Containers<T, S> {
	...
	//Create a set based on the array of T objects
	public Set<T> initSet(T[] tArray);
	
	//Create a list based on the array of T objects
	public List<T> initList(T[] tArray);
	
	//Create a map based on the array of T objects
	public Map<S,T> initMap();
	...
	public boolean addToMap(S key, T value, boolean overwriideExistingValue);
